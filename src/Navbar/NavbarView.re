...
let make = (_children) => {
  ...
  render: _self => {
    ...
    let navLinkDashboard = <a className="nav-link" href="#">
                            ...
                            <span className="nav-link-text">{ReasonReact.stringToElement("Dashboard")}</span>
                          </a>;
    ...
    let navLinkMenu = 
      ReasonReact.cloneElement(
        ...
        [|<i className="fa fa-fw fa-sitemap"></i>, <span className="nav-link-text">{ReasonReact.stringToElement("Menu Levels")}</span>|]
      );
    ...
    <nav className="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      <a className="navbar-brand" href="#">{ReasonReact.stringToElement("Logo")}</a>
      {togglerButton}
